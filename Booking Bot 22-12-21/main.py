...
def booking(driver, date_time_to_book_on, date_target, day_target, from_target_list, to_target_list, filter_1_target, filter_2_target, activity_target, venue_target, subvenue_list_target):
...
def main(date_time_to_book_on, date_target, day_target, filter_1_target, filter_2_target, activity_target, venue_target, subvenue_list_target, from_target_list, to_target_list, purpose_remark):
    try: 
        # # for recording
        ...
        booked = False
        for _ in range(2):
            booking(driver, date_time_to_book_on, date_target, day_target, from_target_list, to_target_list, filter_1_target, filter_2_target, activity_target, venue_target, subvenue_list_target)
            try:
